...
DEFAULT_CLEAN_DIR = Path(r"C:\Users\IMAD\Downloads\LLM-Tweet-Pipeline\clean_client")
DEFAULT_INPUT_CSV = r"C:\Users\IMAD\Downloads\LLM-Tweet-Pipeline\clean_client\free tweet export.csv"
KB_PATH_DEFAULT = r"C:\Users\IMAD\Downloads\LLM-Tweet-Pipeline\kb_replies_rich_expanded.csv"
...
pipeline_model_name = os.getenv("OLLAMA_MODEL", "llama3.1:8b-instruct-q4_0")
...
if engine == "Pipeline complet (BERT+Ollama)":
    ...
    with col_pl1:
        pipeline_model_name = st.text_input(
            ...
            value=os.getenv("OLLAMA_MODEL", "llama3.1:8b-instruct-q4_0"),
